...
export const user_profile_image_URL =
  "https://backend.eatcoast.ca/ef/user/avatar/";

// user profile background Image URL

export const user_profile_coverImage_URL =
  "https://backend.eatcoast.ca/ef/user/background/";
